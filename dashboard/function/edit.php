<?php
	...
	if (isset($_GET['admin-edit'])) {
		...
		if (isset($_POST['admin-update'])) {
			...
			$admin 		=	mysqli_query($GLOBALS["___mysqli_ston"], "UPDATE users 
		...
		$dataadmin 		= 	mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM users WHERE id = $id");
...
<?php
	...
	if (isset($_GET['guru-edit'])) {
		...
		if (isset($_POST['guru-update'])) {
			...
			$guru 		=	mysqli_query($GLOBALS["___mysqli_ston"], "UPDATE users 
		...
		$dataguru 		= 	mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM users WHERE id = $id");
...
<?php
	...
	if (isset($_GET['siswa-edit'])) {
		...
		if (isset($_POST['siswa-update'])) {
			...
			$siswa 		=	mysqli_query($GLOBALS["___mysqli_ston"], "UPDATE users 
											SET `nomor_induk` = '$noinduk', `name` = '$name', `username` = '$username', `telp` = '$telp', 
		...
		$datasiswa 		= 	mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM users WHERE id = $id");
...
<?php
	...
	if (isset($_GET['profile'])) {
		...
		if (isset($_POST['pass-update'])) {
			...
			$users 		=	mysqli_query($GLOBALS["___mysqli_ston"], "UPDATE users 
		...
		$datausers 		= 	mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM users WHERE id = $id");
...
<?php
	...
	if (isset($_GET['alat-edit'])) {
		...
		if (isset($_POST['alat-update'])) {
			...
			$alat 		=	mysqli_query($GLOBALS["___mysqli_ston"], "UPDATE alat 
		...
		$dataalat		= 	mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM alat WHERE alat_id = $id");
...
<?php
	...
	if (isset($_GET['bahan-edit'])) {
		...
		if (isset($_POST['bahan-update'])) {
			...
			$bahan 		=	mysqli_query($GLOBALS["___mysqli_ston"], "UPDATE bahan 
		...
		$databahan		= 	mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM bahan WHERE bahan_id = $id");
...
<?php
	...
	if (isset($_GET['kelas-edit'])) {
		...
		if (isset($_POST['kelas-update'])) {
			...
			$kelas 		=	mysqli_query($GLOBALS["___mysqli_ston"], "UPDATE kelas 
											SET `kelas_nama` = '$nama'
											WHERE kelas_id = '$id'");
			if ($kelas) {
				echo 	"<div class='alert alert-success alert-dismissable'>
		...
		$datakelas		= 	mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM kelas WHERE kelas_id = $id");
...
<?php
	...
	if (isset($_GET['semester-edit'])) {
		...
		if (isset($_POST['semester-update'])) {
			...
			$semester 		=	mysqli_query($GLOBALS["___mysqli_ston"], "UPDATE semester 
		...
		$datasemester	= 	mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM semester WHERE semester_id = $id");
...
<?php
	...
	if (isset($_GET['tahun-edit'])) {
		...
		if (isset($_POST['tahun-update'])) {
			...
			$tahun 		=	mysqli_query($GLOBALS["___mysqli_ston"], "UPDATE tahun 
											SET `tahun_nama` = '$nama'
											WHERE tahun_id = '$id'");
			if ($tahun) {
				echo 	"<div class='alert alert-success alert-dismissable'>
		...
		$datatahun		= 	mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM tahun WHERE tahun_id = $id");
...
<?php
	...
	if (isset($_GET['jenis-edit'])) {
		...
		if (isset($_POST['jenis-update'])) {
			...
			$jenis 		=	mysqli_query($GLOBALS["___mysqli_ston"], "UPDATE jenisnilai 
											SET `jenis_nama` = '$nama'
											WHERE jenis_id = '$id'");
			if ($jenis) {
				echo 	"<div class='alert alert-success alert-dismissable'>
		...
		$datajenis		= 	mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM jenisnilai WHERE jenis_id = $id");
...
<?php
	...
	if (isset($_GET['jadwal-edit'])) {
		...
		if (isset($_POST['jadwal-update'])) {
			...
			$jadwal 		=	mysqli_query($GLOBALS["___mysqli_ston"], "UPDATE jadwal 
		...
		$datajadwal		= 	mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM jadwal WHERE jadwal_id = $id");
...
<?php
	...
	if (isset($_GET['jam-edit'])) {
		...
		if (isset($_POST['jam-update'])) {
			...
			$jam 		=	mysqli_query($GLOBALS["___mysqli_ston"], "UPDATE jam 
											SET `jam_nama` = '$nama'
											WHERE jam_id = '$id'");
			if ($jam) {
				echo 	"<div class='alert alert-success alert-dismissable'>
		...
		$datajam		= 	mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM jam WHERE jam_id = $id");
...
<?php
	...
	if (isset($_GET['jenisperangkat-edit'])) {
		...
		if (isset($_POST['jenisperangkat-update'])) {
			...
			$jenis 		=	mysqli_query($GLOBALS["___mysqli_ston"], "UPDATE jenisperangkat 
		...
		$datajenis		= 	mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM jenisperangkat WHERE jenisperangkat_id = $id");
		$row 			= 	mysqli_fetch_array($datajenis);
	}
?>
<?php
	...
	if (isset($_GET['afektif-edit'])) {
		...
		if (isset($_POST['afektif-update'])) {
			...
			$afektif 		=	mysqli_query($GLOBALS["___mysqli_ston"], "UPDATE nilai 
											SET `nilai_poin` = '$poin'
											WHERE nilai_id = '$id'");
			if ($afektif) {
				echo 	"<div class='alert alert-success alert-dismissable'>
		...
		$datanilai		= 	mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM nilai WHERE nilai_id = $id");
...
<?php
	...
	if (isset($_GET['kognitif-edit'])) {
		...
		if (isset($_POST['kognitif-update'])) {
			...
			$kognitif 		=	mysqli_query($GLOBALS["___mysqli_ston"], "UPDATE nilai 
											SET `nilai_poin` = '$poin'
											WHERE nilai_id = '$id'");
			if ($kognitif) {
				echo 	"<div class='alert alert-success alert-dismissable'>
...
<?php
	...
	if (isset($_GET['psikomotor-edit'])) {
		...
		if (isset($_POST['psikomotor-update'])) {
			...
			$psikomotor 		=	mysqli_query($GLOBALS["___mysqli_ston"], "UPDATE nilai 
											SET `nilai_poin` = '$poin'
											WHERE nilai_id = '$id'");
			if ($psikomotor) {
				echo 	"<div class='alert alert-success alert-dismissable'>
