			...
			<div class="grid-body">
				<form role="form" class="form-horizontal" enctype="multipart/form-data" method="post">
					<div class="form-group">
						...
						<div class="col-md-4">
							<input type="text" class="form-control" name="nama" placeholder="Enter Nama Bahan" required>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-md-4">
							<select class="form-control" name="jenis" required>
								<?php 
									$jenis 		=	mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM jenisperangkat WHERE jenisperangkat_type='Bahan'");
					...
					<div class="form-group">
						<label class="col-sm-2 control-label">Satuan Bahan</label>
						<div class="col-md-4">
							<input type="text" class="form-control" name="satuan" placeholder="Satuan Bahan" required>
						</div>
					</div><hr/>
					<div class="form-group">
