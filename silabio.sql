...
--
-- Host: 127.0.0.1
-- Generation Time: May 23, 2021 at 04:40 AM
...
(4010, 1621737603, '::1', '928674'),
(4009, 1621737563, '::1', '294941');
...
(1, 'Kholiq', '1', NULL, 'kholiq', 'kholiq', 'mhs', '0', '*F1378C253EEBE31F135CC41EF4A98D077EB98F5D', 1, 1, '10', '2021-05-23 09:40:03', '3315132', 'indonesia'),
...
INSERT INTO `kelola_alat` (`id`, `id_nama_alat`, `satuan_alat`, `kategori`, `stok`, `stok_minimal`, `lokasi`, `pendanaan`, `harga`, `kondisi`, `tahun`, `keterangan`) VALUES
(10, '2', '1', '11', 195, 5, '5', '5', 90000, '1', '2020', NULL),
(11, '1', '1', '11', 984, 5, '8', '5', 800000, '3', '2017', NULL),
(15, '5', '1', '11', 1, 2, '5', '5', 100000, '4', '2017', NULL),
(16, '4', '1', '7', 10, 2, '5', '5', 30000, '5', '2017', NULL),
...
INSERT INTO `kelola_bahan` (`id`, `id_nama_bahan`, `satuan_bahan`, `kategori`, `stock`, `stock_minimal`, `lokasi`, `pendanaan`, `harga`, `kondisi`, `tahun`, `jenis`, `keterangan`) VALUES
(3, '2', '1', '6', 5, 5, '5', '4', 90000, '2', '2019', NULL, NULL),
(7, '1', '1', '11', 10, 4, '5', '6', 100000, '1', '2018', 1, NULL),
...
(3, 'KUas', '0', 'huisa', 0, NULL, NULL, 'undefined');
...
(4, 'BJ1', 'files/2021/05/4e51efdbea880b5c6f62e19e7453480d.png', 'Bejana', 'Bejana serba bisa'),
(5, 'KM1', NULL, 'Kamera', 'kamera'),
(6, 'LP1', NULL, 'LUOP', ''),
(7, 'RU1', NULL, 'Ruang 1', ''),
(8, 'KU', NULL, 'Kursi', ''),
(10, 'KUa', 'files/2020/12/3d63ffdd1aa3cccc0fb5f5d375ad712e.png', 'Ruanga', ''),
...
--
-- Dumping data for table `other_dokumen`
--

INSERT INTO `other_dokumen` (`id`, `nama`, `files`, `tgl`) VALUES
(10, 'qweqew', 'files/dokumen/2021/05/10.1109@TII_.2019_.2910416_1.pdf', '2021-05-21 12:26:19');
...
--
ALTER TABLE `cms_captcha`
  MODIFY `captcha_id` bigint(13) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4011;

--
-- AUTO_INCREMENT for table `cms_log`
--
ALTER TABLE `cms_log`
  MODIFY `id_log` int(30) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1404;
