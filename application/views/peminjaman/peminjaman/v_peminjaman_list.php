			...
			<?php
				...
				if ($sesi == '1' || $sesi == '3') {
					if($isi == 'index'){
						...
						echo "<a class='btn btn-primary' href='peminjaman/peminjaman/cetak_peminjaman/' target='_blank'>Cetak Data</a>";
					}
					else if($isi == 'kelola'){
						echo "<a class='btn btn-primary' href='peminjaman/peminjaman/cetak_kelola/' target='_blank'>Cetak Data</a>";
					}
					else if($isi == 'jatuh_tempo'){
						echo "<a class='btn btn-primary' href='peminjaman/peminjaman/cetak_jatuh_tempo/' target='_blank'>Cetak Data</a>";
					}
					else if($isi == 'kelola_peminjaman'){
						echo "<a class='btn btn-primary' href='peminjaman/peminjaman/cetak_kelola_peminjaman/' target='_blank'>Cetak Data</a>";
					}
					else if($isi == 'kelola_penggantian'){
						echo "<a class='btn btn-primary' href='peminjaman/peminjaman/cetak_kelola_penggantian/' target='_blank'>Cetak Data</a>";
					}
				} else {
					# code...
				}
