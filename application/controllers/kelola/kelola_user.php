...
class kelola_user extends CI_Controller {
		...
		else
		{
		    ...
		    else
		    {
		      ...
		      else
		      {
				...
				$data['msg'] = "Data User Baru Disimpan....";
	...
	public function show_editForm($id='')
	{
		...
		else
		{
			if ($this->input->post('password')=='') {
				...
				//$pass_en  = $this->db->query("SELECT PASSWORD('".$this->input->post('password')."') as pass")->row()->pass;
				$pass_en = $this->input->post('password');
				$datapost = array(
				'id'       => $this->input->post('id'),
				'nama'     => $this->input->post('nama'), 
				'username' => $this->input->post('username'), 
	...
	public function show_editForm_file_user($id='')
	{
		...
		else
		{
		    ...
		    else
		    {
		      ...
		      {
		      	if ($this->input->post('password')=='undefined') {
					$datapost = array(
					'id'     => $this->input->post('id'),
					'nama'     => $this->input->post('nama'),
					'email'     => $this->input->post('email'),  
	...
	public function delete($id)
	{
		...
		$this->fungsi->message_box("Data User berhasil dihapus...","notice");
